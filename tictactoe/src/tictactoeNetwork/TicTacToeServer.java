...
public class TicTacToeServer implements Runnable {
	...
	public TicTacToeServer(int port, JTextArea taLog, 
		...
		*****************************************************/
		...
		try {
			taLog.append("server: bundung to port " + port + "\n");
			...
			taLog.append("server: error: cannot bund to port" + port + "\n");
		}
	...
	public void run() {
		...
		*****************************************************/
		...
		try {
			...
			taLog.append("server: connected to client " + socket.getInetAddress() +
			...
			while (true) {
				...
				if (msg.equals("init"))
				{
					...
					taLog.append("Other: row = " + row + ". col" + "\n");
					changeText(row, col);
				}
			}
		} catch (Exception e)  {
	...
	public void send(int row, int col) {
		...
		*****************************************************/
		...
		System.out.println("server: sned");
